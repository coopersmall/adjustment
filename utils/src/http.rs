...
/// A HashMap of HTTP headers
pub type HttpHeaders = HashMap<Box<str>, Box<str>>;

/// A HashMap of HTTP cookies
pub type HttpCookies = HashMap<Box<str>, Box<str>>;

/// A vector of HTTP parameter key value tuples
pub type HttpParams = Vec<(Box<str>, Box<str>)>;

/// A result type for HTTP operations
